...
location_10 = Location("Rogano", "If there’s one Glasgow restaurant to check off the foodie bucket list, this is it. Those iconic art deco doors opened in 1935, and Rogano is still serving up the best in Scottish seafood.", zone_1, category_1, "https://foodanddrink.scotsman.com/wp-content/uploads/2015/04/Rogano2-750x400.jpg", False, False)
location_repository.save(location_10)
location_14 = Location("The Old Hairdresser", "This independent arts venue is hidden away in the city centre and gives local artists a place to showcase their work.", zone_1, category_1, "http://static.designmynight.com/uploads/2014/01/IMG_5454.jpg", False, False)
location_repository.save(location_14)
location_16 = Location("Blythswood Square Spa", "City life dragging you down? If relaxation is in order then you can’t do much better than Blythswood Square, a five star spa hotel in the heart of the city - a hot stone massage and mud wrap await.", zone_1, category_9, "https://i2-prod.glasgowlive.co.uk/incoming/article11102014.ece/ALTERNATES/s615b/Blythswood-Square.jpg", False, False)
location_repository.save(location_16)
location_18 = Location("Central Station", "Subterranean passageways beneath Glasgow’s streets. Visit railway vaults that drove Glasgow’s industrial expansion to become ‘The Second City of The British Empire’, hear tales of the famous and infamous who have travelled the tracks and stood on the platforms of Glasgow Central Station.", zone_1, category_3, "https://www.glasgowcentraltours.co.uk/images/portfolio/grid/tour6.jpg", True, True)
location_repository.save(location_18)
location_19 = Location("Glasgow Film Theatre", "Dubbed the first art house cinema to open outside of London (in 1939), the Glasgow Film Theatre (then the Cosmo) has a reputation to uphold. And uphold it does, with the best selection of foreign language and small release films of any Glasgow cinema - not to mention surroundings which are easy on the eye.", zone_1, category_6, "https://files.list.co.uk/images/g/gft-lights-credit-david-grinly-lst090025.jpg", False, False)
location_repository.save(location_19)
location_20 = Location("The Garage", "A student rite of passage, this Sauchiehall St club holds fond memories for many a Glaswegian. Part of that is queuing up under the big yellow truck - so don't complain about your feet hurting too much. Enjoy the moment - it'll be tinged with nostalgia one day.", zone_1, category_6, "https://i.pinimg.com/originals/e5/69/e8/e569e8f53e8766e7b07a4a4d22185ccb.jpg", False, False)
location_repository.save(location_20)
location_25 = Location("Glasgow Subway", "Grab an all-day ticket and tackle all 14 stops.", zone_1, category_7, "https://media-cdn.tripadvisor.com/media/photo-o/0e/2e/3d/99/historic-livery.jpg", True, False)
location_repository.save(location_25)

# North Glasgow
location_3 = Location("Speirs Wharf", "Barges and house boats line the canal onto a cobbled street with newly developed canal paths with a network of running and cycle routes.", zone_2, category_3, "https://mr1.homeflow-assets.co.uk/files/photo/image/16509/8339/_x683/GCY190045_16.jpg", True, True)
location_repository.save(location_3)
location_21 = Location("Maryhill Burgh Halls", "This municipal building and public halls first opened in 1878 and was designed by a local architect, Duncan McNaughtan, to resemble a French hotel of that time - a popular style in the 1870s.", zone_2, category_2, "https://images.squarespace-cdn.com/content/v1/4ff41e65e4b03ec22b1153c6/1341398997525-15T10DI20HJEUG3W8E7D/ke17ZwdGBToddI8pDm48kK3dNuMkwP2LNr50XTRzknFZw-zPPgdn4jUwVcJE1ZvWQUxwkmyExglNqGp0IvTJZUJFbgE-7XRK3dMEBRBhUpyk3iuybP1XnV8mRX87GvpBgdKE3ozJ7arJ1Ib-s3t4KyQZhU7AP0CJcYtBMg9ZEWU/image-asset.jpeg?format=1500w", False, True)
location_repository.save(location_21)
location_22 = Location("Mackintosh Queen's Cross", "One of Glasgow's hidden architectural gems. The only church in the world designed by the great Scottish architect, designer and artist, Charles Rennie Mackintosh.", zone_2, category_3, "https://i.pinimg.com/originals/de/78/19/de78190dddf7c13d3ee6554593894da0.jpg", True, True)
location_repository.save(location_22)

# Southside
location_4 = Location("The Hidden Gardens", "Great wee sanctuary in the southside urban sprawl.", zone_3, category_4, "https://media.timeout.com/images/105374549/630/472/image.jpg", True, True)
...
location_23 = Location("Pollock Country Park", "As Glasgow’s largest park, there’s so much to explore here that you might want to set a few hours aside just to explore this beautiful green space.", zone_3, category_4, "https://peoplemakeglasgow.com/images/Neighbourhoods/South/pollok-park.jpg", True, True)
location_repository.save(location_23)
location_24 = Location("Pollock House", "The house contains an impressive collection of Spanish paintings, many of which were acquired by the Maxwell family, and the meticulous restoration of the property will let you experience what life was like inside this grand home in the 18th century.", zone_3, category_2, "https://www.visitscotland.com/wsimgs/Pollok-1_1720863373.jpg", False, False)
location_repository.save(location_24)

# East End
location_6 = Location("The People's Palace", "Well-curated museum to dive deeper into how Glaswegians lived before modern day times.", zone_4, category_2, "https://prodglportalv2.azureedge.net/cache/9/9/9/f/d/d/999fdd47ccb23fc992e922f212777f78cece67d0.jpg", False, True)
location_repository.save(location_6)
location_7 = Location("The Necropolis", "A fascinating Victorian garden cemetery adjacent to Glasgow Cathedral.", zone_4, category_3, "https://www.thescottishsun.co.uk/wp-content/uploads/sites/2/2020/02/NINTCHDBPICT000477166197.jpg?strip=all&w=960", True, True)
location_repository.save(location_7)
location_15 = Location("Tibo Bistro", "This licenced café is a popular spot for breakfast, lunch and dinner in the east of the city. Its bohemian decor, good music and friendly staff make for a warm and inviting atmosphere.", zone_4, category_1, "https://i2-prod.glasgowlive.co.uk/incoming/article11025255.ece/ALTERNATES/s615b/Cafe-Tibo.jpg", False, False)
location_repository.save(location_15)

# West End
location_8 = Location("The Botanic Gardens", "Created in 1817, Glasgow Botanic Gardens feature several glasshouses and incredible plantlife.", zone_5, category_4, "https://cdn.shopify.com/s/files/1/0235/4729/files/1_eabc443d-7f9e-46dc-8fd0-1ff91acc64c1.jpg?v=1499621290", True, True)
location_repository.save(location_8)
location_9 = Location("Kelvingrove Art Gallery & Museum", "The most popular attraction in Glasgow. Features vast natural history and art collections.", zone_5, category_2, "https://i.pinimg.com/originals/1a/2e/6b/1a2e6bfa5836a827d8332cedef5d4e99.jpg", False, True)
location_repository.save(location_9)
location_11 = Location("The Grosvenor Cinema", "Leave behind the sticky floors of the multiplex for a more refined affair at the Grosvenor. We’re talking leather armchairs - even couches, if you’re feeling flush - and the licence to take a pint in along with your popcorn.", zone_5, category_6, "https://grosvenorwestend.co.uk/wp-content/uploads/screens.jpg", False, False)
location_repository.save(location_11)
location_12 = Location("Voltaire & Rousseau", "Without a doubt Glasgow’s most unique bookshop, it is packed floor to ceiling with secondhand texts covering all genres and tastes.", zone_5, category_5, "https://i2-prod.glasgowlive.co.uk/incoming/article11024692.ece/ALTERNATES/s810/Voltaire-and-Rousseau.jpg", False, False)
location_repository.save(location_12)
location_13 = Location("Mixed Up Records", "With new releases, rare editions, and some secondhand bargains, a shopping trip for vinyl wouldn’t be complete without visiting Mixed Up Records in Otago Lane.", zone_5, category_5, "https://i2-prod.glasgowlive.co.uk/incoming/article11024829.ece/ALTERNATES/s615b/mixed-up-records.jpg", False, False)
location_repository.save(location_13)
location_17 = Location("The Western Baths", "With a stunning Victorian pool dating back to 1876 in the city, everyone should aim to take a dip in splendid surroundings at least once.", zone_5, category_9, "https://images.squarespace-cdn.com/content/v1/5b4746755cfd79f19b5f423a/1559853669959-L9T78X49NDEE2B54KU73/ke17ZwdGBToddI8pDm48kLmUbQbtDGsZ8YTTasGILul7gQa3H78H3Y0txjaiv_0fDoOvxcdMmMKkDsyUqMSsMWxHk725yiiHCCLfrh8O1z4YTzHvnKhyp6Da-NYroOW3ZGjoBKy3azqku80C789l0lqfkVpRp1g_2L-WsTQRP4LE6B0BTbA_B4hx17Wb5wfjT9mR3gzq1SMR4UIbU98M4g/DSC_5552.jpg?format=2500w", False, False)
